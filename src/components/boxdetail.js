    ...
    return (
        <div className="col c-6">
            <div className="box-D-container" >
                <div className="box-D-img" style={{backgroundImage: `url("${cover}")`}}></div>
            ...
            <div className="box-action">
                ...
                <div>
                    <div><box-icon color="#fff" name='play'></box-icon></div>
                    <div><box-icon color="#fff" name='add-to-queue' type='solid' ></box-icon></div>
                </div>
            </div>
            </div>
        </div>
